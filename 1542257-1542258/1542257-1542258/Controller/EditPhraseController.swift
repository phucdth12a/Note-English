...
class EditPhraseController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var delegate: protocolEditPhraseController?
